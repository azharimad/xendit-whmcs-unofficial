 ...
 * @return array
 */
function xendit_kartukredit_MetaData()
{
    return array(
        'DisplayName' => 'Xendit Kartu Kredit Payment Gateway Module',
 ...
 * @return array
 */
function xendit_kartukredit_config()
{
    return array(
        ...
        'paymentfee' => array(
            ...
            'Size'          => '100',
            'Default'       => '2.9',
            'Description'   => 'Fee Will Added to Invoice and Pay by Client. (Default: 2.000 + 2.9%) + 10%.',
        ),
 ...
 * @return string
 */
function xendit_kartukredit_link($params)
{
    // System parameters
    ...
    if(isset($_POST['payurlgenerator']) || !empty($_POST['payurlgenerator'])) {
        ...
        $img         = $systemUrl . "/modules/gateways/xendit-images/creditcard.png"; 
